...
inline void DrawGame::updateSave() {
	for (unsigned i = 0; i < BOARD_SIZE; i++) {
		for (unsigned j = 0; j < BOARD_SIZE; j++) {
...
Save DrawGame::getSave() {
	updateSave();
	return save;
}

void DrawGame::print() const {
	using namespace std;
...
/* Piece movement */
bool DrawGame::movePiece(unsigned piece, Direction d) {
	using namespace std;
...
/* Jumping */
bool DrawGame::jumpPiece(unsigned jumper, unsigned prey) {
	using namespace std;
