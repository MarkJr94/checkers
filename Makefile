all: checkers.cpp checkers.hpp player.cpp player.hpp game.hpp game.cpp main.cpp
...
tree: checkers.cpp checkers.hpp player.cpp player.hpp game.hpp game.cpp bst.cpp bst.hpp
	g++ -Wall -g -std=c++0x -fopenmp checkers.cpp player.cpp game.cpp bst.cpp -o trees
